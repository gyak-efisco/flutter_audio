...
// import 'package:flutter_audio/player/floatingButton.dart';
import 'package:flutter_audio/player/playlist.dart';
import 'package:flutter_audio/player/seekbar.dart';
...
class PlayerState extends State<Player> with WidgetsBindingObserver {
  ...
  final audioSources = concatenatedAudioSources;
  ...
  Future<void> _init() async {
    ...
    try {
      ...
      await _player.setAudioSource(audioSources,
    ...
    return MaterialApp(
      ...
      home: Scaffold(
          ...
          child: Column(
            ...
            children: [
              ...
              StreamBuilder<PositionData>(
                ...
                builder: (context, snapshot) {
                  return seekbar(_player, context, snapshot);
                },
              ),
              ...
              SizedBox(
                ...
                child: StreamBuilder<SequenceState?>(
                  ...
                  builder: (context, snapshot) {
                    final state = snapshot.data;
                    return playlist(audioSources, state, _player);
                  },
                ),
              ),
            ],
        ...
        floatingActionButton: FloatingActionButton(
          ...
          onPressed: () {
            Navigator.pushNamed(context, '/session-form');
          },
        ),
      ),
    );
